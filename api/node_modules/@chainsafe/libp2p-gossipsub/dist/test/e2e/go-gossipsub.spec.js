 ...
 */
const checkReceivedSubscription = (node, peerIdStr, topic, peerIdx, timeout = 1000) => new Promise((resolve, reject) => {
...
const checkReceivedSubscriptions = async (node, peerIdStrs, topic) => {
...
const awaitEvents = async (emitter, event, number, timeout = 30000) => {
